#include "monitor.h"
# define x_semirange 5 /* this is to define the region to be displayed*/
...
void plot()
{
    ...
    for(a=0;a<=y_semirange*10;a++)/* Drawing the axis of the graph*/
        for(b=0;b<=x_semirange*10;b++)
        {
            graph[a][b]=' ';
            if(b==x_semirange*10)
                graph[a][b]='|';
